...
public class MgmCompanyGui extends Application {
	...
	*/
	...
	public ArrayList<String> shufflePix() {
	    String[] pix = { "Apartments.jpg", "BaseballField.jpg", "BlueApts.jpg", "GasStation.jpg", 
	                     "GrayRoofedHouse.jpg", "HighRiseApts.jpg", "MiniMart.jpg", 
	                     "NM_House.jpg", "OfficeBldg.jpg", "Orchard.jpg", "Patio.jpg", 
	                     "Pool.jpg", "School.jpg", "Shop.jpg", "TennisCourt.jpg" };
	    ArrayList<String> rtnList = new ArrayList<>();
	    for (String s : pix) {
	        String path = "file:src/" + s;  // Update path
	        rtnList.add(path);
	    }
	    Collections.shuffle(rtnList);
	    return rtnList;
